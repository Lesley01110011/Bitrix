  ...
  <div class="container">
    <div class="footer__top">
      <a class="logo footer__logo" href="<?=SITE_DIR?>">
        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/logo-fast-online-light.svg" alt="FASTonline">
      </a>
      ...
      <div class="footer__bottom-block">
        ...
        <div class="footer__pay-block">
          <a class="footer__pay-block-link" href="#">
            <svg>
              <use xlink:href="<?=SITE_TEMPLATE_PATH?>/assets/sprite.svg#icon-mir"></use>
            </svg>
          </a>
          <a class="footer__pay-block-link" href="#">
            <svg>
              <use xlink:href="<?=SITE_TEMPLATE_PATH?>/assets/sprite.svg#icon-visa"></use>
            </svg>
          </a>
          <a class="footer__pay-block-link" href="#">
            <svg>
              <use xlink:href="<?=SITE_TEMPLATE_PATH?>/assets/sprite.svg#icon-mastercard"></use>
            </svg>
          </a>
        </div>
      </div>
...
<script defer src="<?=SITE_TEMPLATE_PATH?>/js/bundle.js"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/logo-fix.js"></script>
</html>
